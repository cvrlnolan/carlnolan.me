...
const ProjectCard = () => {
  return (
    <>
      <div className="w-full md:w-52 bg-white dark:bg-gray-800 overflow-hidden rounded shadow-md transition duration-300">
        <div className="px-6 py-4">
          <div className="font-bold text-xl text-gray-700 dark:text-gray-300 mb-2">
            Project Title
          </div>
        </div>
