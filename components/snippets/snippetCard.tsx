  ...
  return (
    <>
      <Link href={`/snippets/${props.slug}`} passHref>
        <div className="w-full md:w-52 rounded shadow-md p-0.5 bg-gradient-to-tr from-green-300 to-purple-500 cursor-pointer transform motion-safe:hover:scale-105 md:motion-safe:hover:scale-110 transition-transform duration-150">
